...
labyrinth_seal_height = 4;
labyrinth_seal_width = 1.2; 
labyrinth_seal_gap = 1.2;
...
disc_nozzle_length = 20;
disc_nozzle_channel_width = 3;
disc_nozzle_slot = 1;
disc_nozzle_angle = 45;
disc_nozzle_width_min = disc_nozzle_channel_width + disc_thickness * 2;
disc_nozzle_width_max = disc_nozzle_width_min * 1.5;
