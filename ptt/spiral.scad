...
module spiral() {
  ...
  spiral_loops_count = (spiral_external_diameter - spiral_internal_diameter) / 2 / (disc_thickness * 2);
  spiral_height = shell_height - shell_thickness;

  difference() {
    union() {
      my()
      spiral_1024(spiral_internal_diameter / 2, spiral_external_diameter / 2, 360 * spiral_loops_count, disc_thickness, shell_height - shell_thickness);
